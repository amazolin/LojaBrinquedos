...
CREATE DATABASE IF NOT EXISTS loja_brinquedos2;

-- Usa o banco de dados loja_brinquedos
USE loja_brinquedos;
...
CREATE TABLE brinquedos_categorias2 (
    id_brinquedo INT,
    id_categoria INT,
...
INSERT INTO brinquedos (codigo_brinquedo, nome_brinquedo, descricao, detalhes, preco, marca) VALUES
...
INSERT INTO brinquedos_categorias (id_brinquedo, id_categoria) VALUES
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '100'), (SELECT id_categoria FROM categorias WHERE nome_categoria = 'bonecas e Acessórios')),
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '200'), (SELECT id_categoria FROM categorias WHERE nome_categoria = 'bonecas e Acessórios')),
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '300'), (SELECT id_categoria FROM categorias WHERE nome_categoria = 'bonecas e Acessórios')),
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '400'), (SELECT id_categoria FROM categorias WHERE nome_categoria = 'bonecas e Acessórios')),
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '500'), (SELECT id_categoria FROM categorias WHERE nome_categoria = 'bonecas e Acessórios')),
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '600'), (SELECT id_categoria FROM categorias WHERE nome_categoria = 'Veículos')),
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '700'), (SELECT id_categoria FROM categorias WHERE nome_categoria = 'Veículos')),
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '800'), (SELECT id_categoria FROM categorias WHERE nome_categoria = 'Veículos')),
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '900'), (SELECT id_categoria FROM categorias WHERE nome_categoria = 'Veículos')),
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '1000'), (SELECT id_categoria FROM categorias WHERE nome_categoria = 'Jogos de Tabuleiro e Quebra Cabeça')),
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '2000'), (SELECT id_categoria FROM categorias WHERE nome_categoria = 'Jogos de Tabuleiro e Quebra Cabeça')),
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '3000'), (SELECT id_categoria FROM categorias WHERE nome_categoria = 'Jogos de Tabuleiro e Quebra Cabeça')),
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '4000'), (SELECT id_categoria FROM categorias WHERE nome_categoria = 'Jogos de Tabuleiro e Quebra Cabeça')),
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '5000'), (SELECT id_categoria FROM categorias WHERE nome_categoria = 'Mundo Pocotoys')),
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '6000'), (SELECT id_categoria FROM categorias WHERE nome_categoria = 'Mundo Pocotoys')),
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '7000'), (SELECT id_categoria FROM categorias WHERE nome_categoria = 'Mundo Pocotoys')),
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '8000'), (SELECT id_categoria FROM categorias WHERE nome_categoria = 'Mundo Pocotoys'));

-- Inserindo os brinquedos em destaque
INSERT INTO destaques (id_brinquedo) VALUES
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '100')),
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '7000')),
((SELECT id_brinquedo FROM brinquedos WHERE codigo_brinquedo = '400'));

-- Inserindo os membros da equipe
INSERT INTO equipe (nome_membro, rgm, foto_membro) VALUES
('Priscila Diniz', '1234567890', 'priscila_diniz.jpg'),
('Danilo Zamai', '0987654321', 'danilo_zamai.jpg'),
('Murilo Fernandes', '1122334455', 'murilo_fernandes.jpg'),
('Mateus Picoli', '5544332211', 'mateus_picoli.jpg'),
('Paulo Cesar', '1010101010', 'paulo_cesar.jpg'),
('Raphael Godek', '2020202020', 'raphael_godek.jpg');